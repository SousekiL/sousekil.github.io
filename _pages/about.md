...
**Tags:** `Double LASSO` · `Bayesian MCMC` · `Computational Social Science` · `Quantitative History`

- [2025 May] [Project Paper](/portfolio/2025-05-04-literature.html)  
  Bayesian posterior analysis with MCMC to assess coefficient uncertainty and robustness.
- [2024 Dec] [Project Paper](/portfolio/2024-12-01-literature.html), 
  [Slides](http://dx.doi.org/10.2139/ssrn.5126209)  
  Double LASSO for robust causal effect identification.

### Governance Effects and On-/Off-Chain Vote Divergence in DAOs
**Tags:** `Causal Inference` · `Regression Discontinuity` · `Decentralized Finance` · `Financial Economics`
...
**Tags:** `Extreme Value Theory` · `Climate Risk` · `Quantitative Risk Management`
...
**Tags:** `Computational Social Science` · `Spatial Analysis` · `Data Visualization`
